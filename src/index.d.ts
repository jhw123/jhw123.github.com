...
export interface GatsbyNode {
   ...
   */
  unstable_shouldOnCreateNode?<TNode extends object = {}>(args: { node: TNode }, options?: PluginOptions): boolean
   ...
   */
  createSchemaCustomization?(args: CreateSchemaCustomizationArgs, options: PluginOptions): any
  createSchemaCustomization?(args: CreateSchemaCustomizationArgs, options: PluginOptions): Promise<any>
...
export interface GatsbyBrowser {
  ...
  onServiceWorkerUpdateReady?(args: ServiceWorkerArgs, options: PluginOptions): any
...
export interface CreateNodeArgs<TNode extends object = {}> extends ParentSpanPluginArgs {
  node: Node & TNode
  traceId: string
  traceTags: {
    nodeId: string
...
export interface CreatePageArgs<TContext = Record<string, unknown>> extends ParentSpanPluginArgs {
  page: Page<TContext>
  traceId: string
}
...
export interface Actions {
  ...
  createParentChildLink(args: { parent: Node; child: Node }, plugin?: ActionPlugin): void
  ...
  addThirdPartySchema(args: { schema: object }, plugin?: ActionPlugin, traceId?: string): void
  ...
  createFieldExtension(extension: object, plugin?: ActionPlugin, traceId?: string): void
